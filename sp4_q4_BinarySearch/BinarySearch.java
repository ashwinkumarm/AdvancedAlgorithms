...
public class BinarySearch {
	...
	/**
	 * Recursive method which runs binary search on a sorted array and return the index of the largest element that
   	 * is less than or equal to x such that arr[i] <= x < arr[i+1].
	 *
	 * @param A: array. Precondition: A is sorted. If A is not sorted,
	 ...
	 * @return index of the largest element that
   	 * is less than or equal to x such that arr[i] <= x < arr[i+1]. else return -1
	 */
